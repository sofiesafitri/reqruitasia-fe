<template>
  <div>
    <div class="new-auth-layout__desc col sm-hide xs-hide lg-col-7 md-col-7">
      <div class="user-auth-desc">
        <h1>Login Portal for<br> Candidates</h1>
        <span class="pl">Not a Candidate? <a href="/auth/login" class="link-can">Login as an Employer</a></span>
      </div>
    </div>
    ...
    <div class="new-auth-layout__form justify-center sm-col-12 lg-col-5 md-col-5">
      <div class="mobile-black-screen flex flex-column flex-content-center col-10 lg-col-8 md-col-8 sm-col-10">
        <h2 class="sm-hide xs-hide mb2">Sign in to Reqruitasia</h2>
        <div class="md-hide lg-hide my3">
          <h1 class="mobile-color-white">Welcome Back<br> Candidates!</h1>
          <span class="color-grey">Not a Candidate? <a href="https://employer.reqruitasia.com/auth/login" class="color-grey underline">Login as an Employer</a></span>
        </div>

        <div class="third-party">
          <button id="google" class="third-party__button bold" @click="socialLogin('google')">
            <img src="~/assets/images/icons/social/google-logo.svg" alt="google"/>
            <span> Sign in with Google</span>
          </button>
          <button id="linkedIn" class="third-party__button bold" @click="socialLogin('linkedin')"> 
            <img src="~/assets/images/icons/social/linkedIn-logo.svg" alt="linkedIn"/>
            <span>Sign in with Linkedin</span>
            </button>
          <button id="facebook" class="third-party__button bold" @click="socialLogin('facebook')">
            <img src="~/assets/images/icons/social/facebook-logo.svg" alt="facebook"/>
            <span>Sign in with Facebook</span>
          </button>
        </div>

        <span class="center m2 ps">Or</span>
